        ...
        <div className='md:w-[700px] w-[330px] relative bg-custom-purple py-5 md:px-10 px-5'>
            ...
            {cartData?.map((item, i) => (<div key={i} className="grid md:grid-cols-9 grid-cols-1 w-full md:gap-5 mt-5">
              ...
              <div className="flex md:justify-center justify-start md:items-center items-start col-span-3 md:mt-0 mt-5">
                <div className='bg-custom-offWhite w-[153px] h-[39px] rounded-[8px] flex justify-center items-center'>
                  ...
                  <p className='text-black md:text-xl text-lg font-medium text-center mx-5'>{item?.qty}</p>
          ...
          <div className="bg-white w-full rounded-[5px] boxShadows md:p-5 p-2 mt-5">
            ...
            <div className="flex justify-between items-center w-full pt-3">
              ...
              <p className="text-custom-purple font-normal text-base">₹{deliveryCharge}</p>
            ...
            <div className="flex justify-between items-center w-full pt-3 border-b border-b-[#97999B80] pb-5">
              ...
              <p className="font-normal text-base text-custom-purple">₹{deliveryPartnerTip}</p>
            </div>

            <div className="flex justify-between items-center w-full pt-5">
              <p className="text-custom-purple font-normal text-base">Total Payable</p>
              <p className="text-custom-purple font-medium text-base">₹{mainTotal}</p>
            </div>
          </div>
          ...
          >CONTINUE TO PAY ₹{CartTotal}</button>
        ...
        <div className="relative w-[300px] md:w-[360px] h-auto  bg-white rounded-[15px] m-auto">
          ...
          <form className='px-5 py-5' onSubmit={createProductRquest}>
            ...
            <div className='flex md:justify-start justify-center'>
              <button className='bg-custom-purple w-full md:h-[50px] h-[40px] rounded-[5px] text-white font-normal text-base' type="submit">Place Order</button>
            </div>
