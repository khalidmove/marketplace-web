                    ...
                    <div className="max-w-7xl mx-auto w-full md:px-0 px-5 md:pt-10 pt-5">
                        ...
                        <form className="grid md:grid-cols-2 grid-cols-1 w-full md:gap-0 gap-5 md:pt-10 pt-5" onSubmit={submit}>
                            ...
                            <div className="flex flex-col justify-center border border-black rounded-[15px] md:p-10 p-5">
                                <p className="md:text-3xl text-2xl text-black font-bold  md:pb-10 pb-5 text-center">Sign up</p>
                                <input className="bg-white w-full md:h-[50px] h-[40px] px-5 rounded-[5px] border border-black font-normal md:text-lg text-base text-black outline-none mb-5" type="text" placeholder="Name"
                                    required
                                ...
                                <input className="bg-white w-full md:h-[50px] h-[40px] px-5 rounded-[5px] border border-black font-normal md:text-lg text-base text-black outline-none mb-5" type="text" placeholder="Email"
                                    required
                                ...
                                <div className='relative'>
                                    <input className="bg-white w-full md:h-[50px] h-[40px] px-5 rounded-[5px] border border-black font-normal md:text-lg text-base text-black outline-none" placeholder="*********"
                                        required
                                ...
                                <button className="bg-custom-purple md:h-[50px] h-[40px] w-full rounded-[10px] font-bold md:text-xl text-base text-white md:mb-10 mb-5 mt-5" type="submit">Sign up</button>
